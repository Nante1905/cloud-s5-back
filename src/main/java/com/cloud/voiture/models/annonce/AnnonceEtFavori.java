...
public class AnnonceEtFavori {
  ...
  public AnnonceEtFavori(int id, String reference, String description,
      int status,
      BigDecimal prix,
      BigDecimal commission, Integer nbVue, int idUtilisateur, int idVoiture, Timestamp dateCreation,
      boolean favori) {
    setId(id);
  ...
  public AnnonceEtFavori() {
  }

  public void setPrix(BigDecimal p) {
    setPrix(p.doubleValue());
  }

  public void setCommission(BigDecimal p) {
    setCommission(p.doubleValue());
  }
